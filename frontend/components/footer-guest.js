    ...
    footer.innerHTML =
      '<div class="footer-inner">' +
        ...
        '<div class="footer-nav">' +
          '<a href="/frontend/pages/guest/team-search/index.html">TEAM</a>' +
          '<span class="footer-nav-dot">&middot;</span>' +
          '<a href="/frontend/pages/guest/puzzle/index.html">PUZZLES</a>' +
          '<span class="footer-nav-dot">&middot;</span>' +
          '<a href="/frontend/pages/guest/contest/index.html">CONTEST</a>' +
          '<span class="footer-nav-dot">&middot;</span>' +
          '<a href="/frontend/pages/guest/announcement/index.html">ANNOUNCEMENTS</a>' +
          '<span class="footer-nav-dot">&middot;</span>' +
          '<a href="/frontend/pages/guest/auth/login.html">LOGIN</a>' +
        '</div>' +
